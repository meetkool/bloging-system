...
var contentlayer_config_default = makeSource({
  ...
  mdx: {
    rehypePlugins: [
      ...
      // Note: rehype-pretty-code temporarily removed due to version compatibility issues
      // We'll add syntax highlighting back once the dependency issues are resolved
    ]
  }
});
export {
...
//# sourceMappingURL=compiled-contentlayer-config-EFIFB3JU.mjs.map
